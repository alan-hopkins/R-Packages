# # HEADER
#'  Display:     PhUSE Figure 7.1 Box plot - Measurements by Analysis Timepoint, Visit and Treatment
...
#' @import tools
#' @export
bplot_cfb <- function(data, treatmentname, useshortnames = c(TRUE,FALSE),oldnames, newnames,
